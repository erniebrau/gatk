...
public final class VariantAnnotatorEngine {
    ...
    public Set<VCFHeaderLine> getVCFAnnotationDescriptions() {
        ...
        Utils.validateState(!descriptions.contains(null), "getVCFAnnotationDescriptions should not contain null. This error is likely due to an incorrect implementation of getDescriptions() in one or more of the annotation classes");
        return descriptions;
    }
