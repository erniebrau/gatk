...
public final class ProgressMeter {
     ...
     */
    public void start() {
        Utils.validateState( !started, "the progress meter has been started already");
        Utils.validateState( !stopped, "the progress meter has been stopped already");
        started = true;
    ...
    public void update( final Locatable currentLocus ) {
        Utils.validateState(started, "the progress meter has not been started yet");
        Utils.validateState( !stopped, "the progress meter has been stopped already");
        ++numRecordsProcessed;
