...
final class SamplePartitioner {
    ...
    public void submitRead(final GATKRead read) {
        ...
        Utils.validateState(downsampler != null, () -> "Offered read with sample name " + sampleName + " to SamplePartitioner " +
    ...
    public Collection<GATKRead> getReadsForSample(final String sampleName) {
        Utils.validateState(doneSubmittingReads, "getReadsForSample called before doneSubmittingReads was called");
