...
public final class DataLine {
    ...
    public String get(final int index) {
        Utils.validIndex(index, values.length);
        Utils.validateState(values[index] != null, () -> "requested column value at " + index + " has not been initialized yet");
        return values[index];
    }
    ...
    public String get(final String columnName) {
        ...
        Utils.validateState(values[index] != null, () -> String.format("the value for column '%s' is undefined", columnName));
        return values[index];
    }
    ...
    public DataLine append(final String value) {
        Utils.validateState(nextIndex < values.length, "gone beyond of the end of the data-line");
