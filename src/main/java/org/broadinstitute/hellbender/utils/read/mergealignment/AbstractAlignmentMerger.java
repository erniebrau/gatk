...
public abstract class AbstractAlignmentMerger {
    ...
    public void mergeAlignment(final File referenceFasta) {
        ...
        Utils.validateState(!alignedIterator.hasNext(), () -> "Reads remaining on alignment iterator: " + alignedIterator.next().getReadName() + "!");
    ...
    protected void setProgramRecord(final SAMProgramRecord pg) {
        Utils.validateState(programRecord == null, "Cannot set program record more than once on alignment merger.");
        programRecord = pg;
