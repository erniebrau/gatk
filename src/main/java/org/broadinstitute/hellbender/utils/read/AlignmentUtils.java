...
public final class AlignmentUtils {
    ...
    public static Cigar trimCigarByReference(final Cigar cigar, final int start, final int end) {
        ...
        Utils.validateState(result.getReferenceLength() == end - start + 1, () -> "trimCigarByReference failure: start " + start + " end " + end + " for " + cigar + " resulted in cigar with wrong size " + result);
        return result;
    }
    ...
    public static Cigar trimCigarByBases(final Cigar cigar, final int start, final int end) {
        ...
        Utils.validateState(result.getReadLength() == expectedSize, () -> "trimCigarByBases failure: start "
