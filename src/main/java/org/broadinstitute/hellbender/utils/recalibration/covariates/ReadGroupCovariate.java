...
public final class ReadGroupCovariate implements Covariate {
    ...
    public String formatKey(final int key) {
        Utils.validateState(readGroupReverseLookupTable.containsKey(key), () -> "missing key " + key);
    ...
    private int keyForReadGroup(final String readGroupId) {
        Utils.validateState(readGroupLookupTable.containsKey(readGroupId), () -> "The covariates table is missing " + RecalUtils.READGROUP_COLUMN_NAME + " " + readGroupId + " in " + RecalUtils.READGROUP_REPORT_TABLE_TITLE);
