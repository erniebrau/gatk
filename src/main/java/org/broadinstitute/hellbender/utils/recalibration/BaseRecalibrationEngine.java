...
public final class BaseRecalibrationEngine implements Serializable {
    ...
    public void finalizeData() {
        Utils.validateState(!finalized, "FinalizeData() has already been called");
    ...
    public RecalibrationTables getFinalRecalibrationTables() {
        Utils.validateState(finalized, "Cannot get final recalibration tables until finalizeData() has been called");
        return recalTables;
    }
